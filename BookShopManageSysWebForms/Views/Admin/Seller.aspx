<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Seller.aspx.cs" Inherits="BookShopManageSysWebForms.Views.Admin.Seller" %>
...
&nbsp;<input type="password" placeholder="Password" autocomplete="off" runat="server" id="AddressTb" class="form-control" />
                    </div>
