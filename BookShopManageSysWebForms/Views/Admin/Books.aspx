<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Books.aspx.cs" Inherits="BookShopManageSysWebForms.Views.Admin.Books" %>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:DropDownList id="BAuthCb" class="form-control" runat="server"></asp:DropDownList>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:DropDownList id="BCatCb" class="form-control" runat="server"></asp:DropDownList>
